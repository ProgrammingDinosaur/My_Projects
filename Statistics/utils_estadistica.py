...
def media_agrupada(valores: np.ndarray, intervalo: int):
    return statistics.median_grouped(valores,intervalo)

def moda_agrupada_mismos_intervalos(tabla_dist: pd.DataFrame,frec_abs_idx = 1):
